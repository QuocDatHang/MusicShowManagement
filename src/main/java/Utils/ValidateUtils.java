...
public class ValidateUtils {
    private final static String REGEX_NAME = "^[A-Z][a-z ]{2,18}$";

    private final static String REGEX_ACCOUNTNAME = "^[A-Za-z][A-Za-z0-9_]{7,19}$";
    private final static String REGEX_PASSWORD = "^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d@$!%*?&]{8,20}$";
    private final static String REGEX_EMAIL = "^[A-Za-z][a-zA-Z0-9_]{5,32}@[a-z0-9]{2,}(\\.[a-z0-9]{2,4}){1,2}$";
    private final static String REGEX_ADDRESS = "^[A-Za-z ]{2,}$";
