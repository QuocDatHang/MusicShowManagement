...
public class ValidateUtils {
    ...
    private final static String REGEX_ACCOUNTNAME = "^[A-Za-z][A-Za-z0-9_]{5,19}$";
    ...
    private final static String REGEX_SHOWNAME = "^[A-Z0-9][A-Za-z0-9 ]{2,30}$";
    public static boolean isValidShowName(String showName){
        return Pattern.matches(REGEX_SHOWNAME, showName);
    }
    private final static String REGEX_SINGER = "^[A-Z][A-Za-z ]{2,18}$";
